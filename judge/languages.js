...
const LANGUAGES = {
  ...
  java:       { label: 'Java',               sourceFile: 'Main.java',
                // javac is itself a JVM tool, so it also over-reserves heap on a big box and dies
                // at startup ("Could not allocate metaspace"). Pass memory caps to its JVM via -J.
                compile: ['javac', '-J-Xmx256m', '-J-XX:MaxMetaspaceSize=128m', '-J-XX:CompressedClassSpaceSize=64m', '-J-XX:+UseSerialGC', 'Main.java'],
